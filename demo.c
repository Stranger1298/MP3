...
void greetings()
{
    ...
    printf("\t\t\t     *                                      *\n");
    printf("\t\t\t     *                                      *\n");
    printf("\t\t\t     *      Bangalore,Karnataka,India       *\n");
...
struct book *initialize_lib(struct book *start)
{
    ...
    new_book1->next = NULL;
    start_lib = new_book1;
    strcpy(new_book1->name, "DSA using C");
    strcpy(new_book1->author, "Author 1");
    new_book1->id = 101;
    ptr = new_book1;

    new_book2 = (struct book *)malloc(sizeof(struct book));
    new_book2->next = NULL;
    strcpy(new_book2->name, "OOPS in Java");
    strcpy(new_book2->author, "Author 2");
    new_book2->id = 102;
    ptr->next = new_book2;
    ptr = new_book2;
    ...
    new_book3->next = NULL;
    strcpy(new_book3->name, "Python");
    strcpy(new_book3->author, "Author 3");
    new_book3->id = 103;
    ptr->next = new_book3;
    ptr = new_book3;
    ...
    new_book4->next = NULL;
    strcpy(new_book4->name, "Programming in C++");
    strcpy(new_book4->author, "Author 4");
    new_book4->id = 104;
    ptr->next = new_book4;
    ptr = new_book4;
    ...
    new_book5->next = NULL;
    strcpy(new_book5->name, "Web development");
    strcpy(new_book5->author, "Author 5");
    new_book5->id = 105;
    ptr->next = new_book5;
